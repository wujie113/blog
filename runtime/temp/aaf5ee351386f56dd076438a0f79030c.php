...
<div class="page-content qf_content">
	...
	<div class="widget-body">
	 	<header style="text-align: center;">
			<h2 style="color: #57b5e3;display: inline-block;">部门管理</h2>
		</header>
	 	...
	 	<table class="table table-striped table-hover table-bordered qf_record" id="editabledatatable" style="text-align: center;margin-top: 15px;">
	        ...
	        <tbody  class="qf_manage_tbody">
	            <tr>
	                <td ><a href="<?php echo url('Comserv/depardetail'); ?>">媒介部</a></td>
	                <td class="deepBlue">
	                	<label>7</label>
	                </td>
	                <td>
	                    <a href="<?php echo url('Comserv/depardetail'); ?>" class="btn btn-info btn-xs edit"><i class="glyphicon glyphicon-folder-open"></i> 详情</a>
	                </td>
	            </tr>
	            <tr>
	                <td ><a href="<?php echo url('Comserv/depardetail'); ?>">市场部</a></td>
	                <td class="deepBlue">
	                	<label>3</label>
	                </td>
	                <td>
	        	...
	        	<tr>
	                <td ><a href="<?php echo url('Comserv/depardetail'); ?>">技术部</a></td>
	                <td class="deepBlue">
	                	<label>2</label>
	                </td>
	                <td>
