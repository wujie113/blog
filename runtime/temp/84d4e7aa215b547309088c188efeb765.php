...
<div class="qf_content page-content">
	<header >
		<label>会员ID：</label>
		<input type="text" id="recordinput" style="width: 150px;padding-left: 3px;"/>
		<input type="button" id="redordinput" value="提交" />
	</header>
     <hr class="wide" />
    <form method="post" action="">
	    <input type="button" id="redordinput" value="全部删除" />
	    <table class="table table-striped table-hover table-bordered qf_record"  style="text-align: center;margin-top: 15px;">
	        <thead class="web_record_thead">
	            <tr>
	            	<th >
	            		<input class="checkAll"  type="checkbox" style="opacity: 1;position: relative;" />
	            		&nbsp;<label style="margin-top: -4px;">全选</label>
	            	</th>
	            	<th >会员名称</th>
	            	<th >日期</th>
	            	<th >订单</th>
	        ...
	        <tbody  class="qf_manage_tbody" style="text-align: center;">
	            <tr >
	               <th >
						<input type="checkbox"  style="opacity: 1;position: relative;" class="child_item" name="box[]" value="" />
	            		&nbsp;<label style="margin-top: -4px;">1111</label>
					</th>
					<th>
						<label>7.4451</label>
					</th>
...
<script type="text/javascript">
	$(document).on("click", ".checkAll", function (e) {   
        $(".child_item").prop('checked', $(this).prop("checked")); 
