...
<!--	    <link href="http://fonts.useso.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,400,600,700,300" rel="stylesheet" type="text/css">-->
  ...
  <div class="page-content qf_content" >
  	 <div class="widget-body">
 		 <header >
 			<a class="qf_a" onclick="javascript:history.go(-1);" style="margin-top: 4px;">返回</a>
 			<span style="font-size: 20px;margin-left: 30px;">人员：西西 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日期：2017-11-20</span>
 			<span style="float: right;font-size: 20px;margin-top: 6px;">合计：0元</span>
 		</header>
         <hr class="wide" />
 		 <span>注意： 红色部分标记的记录是业绩对半的联盟站点，对应的格式为 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   最终业绩（ 实际金额 | 业绩费率）</span>	
