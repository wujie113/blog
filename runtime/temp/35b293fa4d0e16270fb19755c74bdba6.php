...
<div class="page-content qf_content">
	<div class="widget-body">
       <header >
       		<h3 style="float: left;">只显示最近十周</h3>
       		<a href="addweekly.html" class="check-a" style="float: right; margin-bottom: 20px;">添加周报</a>
       		<br />
       </header>
    	<table class="table table-striped table-hover table-bordered qf_record" id="editabledatatable" style="text-align: center;">
            ...
            <tbody style="font-size: 12px;font-weight: normal;">
                <tr>
                    <td class="red">
                    	<a href="weeklydetail.html">伍洁</a>
                    </td>
                    <td class="red">
                    	<a href="weeklyDetail.html">2017-11-13 -- 2017-11-19</a>
                    </td>
                    <td>
                    	 <a href="addWeekly.html" class="btn btn-info btn-xs edit btn-individual"><i class="fa fa-edit"></i> 编辑</a>
                        <a href="weeklyDetail.html" class="btn btn-info btn-xs edit"><i class="glyphicon glyphicon-folder-open"></i> 详情</a>
                    </td>
                </tr>
