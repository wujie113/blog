...
<div class="row">
        <form action="<?php echo url('articleupdate/updatesusseful'); ?>"  method="post" class="add-article-form">
          ...
          <div class="col-md-9">
            ...
            <input type="hidden" name="up_id"  value="<?php echo $val['id']; ?>" />
            <div class="form-group">
              <label for="article-title" class="sr-only">标题</label>
              <input type="text" id="article-title" name="up_title" class="form-control" value="<?php echo $val['title']; ?>"  placeholder="在此处输入标题" required autofocus autocomplete="off">
            </div>
            <div class="form-group">
              <label for="article-content" class="sr-only">内容</label>
              <script id="article-content" name="up_content" type="text/plain" ><?php echo $val['content']; ?></script>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>关键字</span></h2>
              <div class="add-article-box-content">
              	<input type="text" class="form-control" placeholder="请输入关键字" value="<?php echo $val['keywords']; ?>" name="up_keywords" autocomplete="off">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
              	<textarea class="form-control" name="up_describe" autocomplete="off"  ><?php echo $val['describe']; ?></textarea>
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <ul class="category-list">
                  <li>
                    <label>
                      <input name="up_category" type="radio" value="1" <?php if($val['type']=='技术探讨'): ?>checked<?php endif; ?> >
                       <em class="hidden-md">技术探讨 </em></label>
                  </li>
                  <li>
                    <label>
                      <input name="up_category" type="radio" value="2"  <?php if($val['type']=='慢生活'): ?>checked<?php endif; ?>>
                    <em class="hidden-md">慢生活</em></label>
                  </li>
                  <li>
                    <label>
                      <input name="up_category" type="radio" value="3"  <?php if($val['type']=='js'): ?> checked <?php endif; ?>>
                  <em class="hidden-md">js</label>
                  </li>
                 <li>
                    <label>
                      <input name="up_category" type="radio" value="3"  <?php if($val['type']=='html'): ?> checked <?php endif; ?>>
                  <em class="hidden-md">html</label>
                  </li>
                </ul>
              </div>
            </div>
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" class="form-control" placeholder="点击按钮选择图片" id="pictureUpload" name="up_titlepic" value="<?php echo $val['titlepic']; ?>" autocomplete="off">
              </div>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <p><label>公开度：</label><input type="radio" name="up_visibility" value="0" <?php if($val['type']==0): ?>checked<?php endif; ?> />公开 
                	<input type="radio" name="up_visibility" value="1" <?php if($val['type']==1): ?>checked<?php endif; ?> />加密</p>
                <p><label>发布于：</label><span class="article-time-display"><input style="border: none;" type="datetime" name="up_time" value="<?php echo date('Y-m-d'); ?>" /></span></p>
              </div>
              <div class="add-article-box-footer">
