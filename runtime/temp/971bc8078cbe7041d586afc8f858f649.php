     ...
     <form action="" method="post">
     	<div class="margin-bottoms">
     		...
     		<div class="form-label">
     			<label>
                    <input name="status" type="radio" class="colored-blue">
                    <span class="text"> 投放中</span>
                </label>
                <label class="margins-5" >
                    <input name="status" type="radio" class="colored-blue">
                    <span class="text"> 下代码</span>
                </label>
                <label class="margins-5">
                    <input name="status" type="radio" class="colored-blue">
                    <span class="text"> ★新联系方式</span>
                </label>
                <label class="margins-5">
                    <input name="status" type="radio" class="colored-blue">
                    <span class="text"> ★沟通中</span>
                </label>
     		</div>
     	</div>
     	<div class="margin-bottoms">
     	...
     	<div class="margin-bottoms">
     		...
     		<div class="form-label">
     			<textarea name="put_info" class="form-controls form-boxed">摘要信息</textarea>
     		</div>
     	</div>
     	<div class="margin-bottoms">
     		<div class="form-group-col-2" >
     	...
     	<div class="margin-bottoms">
     		...
     		<div class="form-label">
     			<span class="input-icon icon-right" style="display: inline-block;width: 300px;">
                    <input type="text" class="form-controls" placeholder="请输入日付.....">
     	...
     	<div class="margin-bottoms">
     		...
     		<div class="form-label">
     			<span class="input-icon icon-right" style="display: inline-block;width: 300px;">
                    <input type="text" class="form-controls" placeholder="请输入ip.....">
                    <i class="fa fa-globe"></i>
                </span>
     		</div>
     	</div>
