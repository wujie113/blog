  ...
  <div class="page-content qf_content" > 
	 ...
	 <div class="widget-body">
	 	<header class="header-data">
			...
			<button class="btn btn-blue btn-status" id="addwebstatusm" >提交</button>
		</header>
	 	<hr class="margin-bottoms" />
	 	<div>
	 		<div class="achieve">
	 			<label >2017-11-20</label>
	 			<h2 >业绩统计</h2>
	 			<span  class="red">（若有数据不对问题，点击右边更新即可！）</span>
	 		</div>
	 		<a href="#" class="btn btn-blue btn-status a-achieve">更新</a>
	 	</div>
	 	<table class="table table-striped table-hover table-bordered qf_record" id="editabledatatable" style="text-align: center;margin-top: 15px;">
	        ...
	        <tbody  class="qf_manage_tbody">
	            <tr>
	                <td ><a href="recorddetail.html">西西</a></td>
	                <td>
	                	<label>0元</label>
	                </td>
	                <td>
	                    <a href="recorddetail.html" class="btn btn-info btn-xs edit"><i class="glyphicon glyphicon-folder-open"></i> 详细</a>
	                </td>
	            </tr>
	            <tr>
	                <td ><a href="recorddetail.html">君君</a></td>
	                <td>
	                	<label>0元</label>
	                </td>
	                <td>
	         	...
	         	<tr>
	                <td ><a href="recorddetail.html">彬彬</a></td>
	                <td >
	                	<label>0元</label>
	                </td>
	                <td>
	            ...
	            <tr>
	                <td ><a href="recorddetail.html">前永</a></td>
	                <td>
	                	<label>0元</label>
	                </td>
	                <td>
	            ...
	            <tr>
	                <td ><a href="recorddetail.html">尹可</a></td>
	                <td>
	                	<label>0元</label>
	                </td>
	                <td>
	            ...
	            <tr>
	                <td ><a href="recorddetail.html">黄佛海</a></td>
	                <td>
	                	<label>0元</label>
	                </td>
	                <td>
