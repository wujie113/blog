...
<div class="page-content qf_content">
	 ...
	 <div class="widget-body">
	 	<header  >
 			<a class="qf_a weeky-a" style="padding: 10px;margin-bottom: 6px;" onclick="" >更新数据</a>
 			<a class="qf_a weeky-input" style="padding: 10px;" onclick="" >同步账户余额</a>
       		<br />
		</header>
	 	<hr style="clear: both;" />
