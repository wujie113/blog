...
<div class="page-content qf_content">
	 <div class="widget-body">
	 	<header >
 			<h2 style="color: #57b5e3;padding-left: 10px;display: inline-block;">登陆日志</h2>
		</header>
				...
				<tbody>
					<tr>
					  <td>
						 ...
						 &nbsp;
						<select name="type" id="">
							<option value="0" selected="">登陆IP</option>
							<option value="1">登陆名称</option>
						</select>
						&nbsp;
	 	...
	 	<table class="table table-striped table-hover table-bordered qf_record" id="editabledatatable" style="text-align: center;margin-top: 15px;">
            ...
            <tbody  class="qf_manage_tbody">
                <tr>
                	<td ><label class="blacks">qianyong</label></td>
                	<td><label class="lightBlue">2017-11-23 09:59:12</label></td>
                	<td  ><font>119.122.247.139 <span style="font-weight:bold;color:green;margin:0 10px;">|</span> 广东省/深圳市/电信</font></td>
                	<td >
              			<span class="qf_login_span qf_success">成功</span>
                	</td>
