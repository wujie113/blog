...
<div class="page-content qf_content" >
	 <div class="widget-body">	
	    <header >
			<a class="qf_as"  onclick="javascript:history.go(-1);">返回</a>
		</header>
	     <hr  />
	    <label style="font-size: 18px;">2017-11-16 </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label style="font-size: 24px;">质检详情页</label>
		 	<table class="table table-striped table-hover table-bordered qf_record" id="editabledatatable" style="text-align: center;margin-top: 15px;">
	            ...
	            <tbody  class="qf_manage_tbody">
	                <tr>
	                    <td ><label>http://www.type-7.cn/?m=vod-detail-id-3989.html</label></td>
	                    <td class="deepBlue">
	                    	<label>7612</label>
	                    </td>
	                    <td class="deepBlue">
	                    ...
	                    <td>
	                       <label>uc浏览器,safri浏览器,qq浏览器</label>
	                    </td>
	                     <td >
	                     	<label>下bannar广告被其他广告覆盖（已解决）</label>
	                     </td>
	                    <td class="deepBlue">
	                    	<label>伍洁</label>
	                    </td>
	                    ...
	                    <td>
	                       <a href="addRecord.html" class="btn btn-info btn-xs edit"><i class="glyphicon glyphicon-pencil"></i>修改</a>
	                       <a href="#" class="btn btn-info btn-xs edit"><i class="glyphicon glyphicon-trash"></i>删除</a>
	                    </td>
	                </tr>
