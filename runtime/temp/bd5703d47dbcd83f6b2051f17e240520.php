...
<!--	    <link href="http://fonts.useso.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,400,600,700,300" rel="stylesheet" type="text/css">-->
  ...
  <div class="page-content qf_content" >
  	...
  	<div class="widget-body">
	 	<header >
 			<h2 style="color: #57b5e3;padding-left: 10px;display: inline-block;">站长业绩费率设置</h2>
		</header>
	 	...
	 	<table class="table table-striped table-hover table-bordered qf_record" id="editabledatatable" style="text-align: center;margin-top: 15px;">
            ...
            <tbody  class="qf_manage_tbody">
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0)" onclick="fn(this)" class="btn btn-info btn-xs edit btn-individual"><i class="fa fa-edit"></i> 编辑</a>
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0)" onclick="fn(this)" class="btn btn-info btn-xs edit btn-individual" onclick="close()"><i class="fa fa-edit"></i> 编辑</a>
                        <a href="#" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i> 删除</a>
                    </td>
                </tr>
            	<tr>
	...
	<div class="qf_bomb_div qf_bomb_padding" >
	  <form action="" method="post">
		<div class="margin-bottoms">
     	...
     	<div style="position: absolute;top: 4px;right: 5px;" class="webRate">
...
<script type="text/javascript">
	$('.webRate').click(function(){
		$('.qf_fixed').css('display','none');
		$('.qf_bomb_rate').css('display','none')
	});
	function fn(){
		$('.qf_fixed').css('display','block');
		$('.qf_bomb_rate').css('display','block');
	}
</script>
</div>
        <!-- /Page Container -->
