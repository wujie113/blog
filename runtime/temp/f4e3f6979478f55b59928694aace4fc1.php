...
<div class="page-content qf_content" >
	<div class="widget-body">
       <header >
       		<a href="#" class="check-a">2017年</a>
       		<br />
       		<br />
       		<br />
       		<a href="#" class="check-a" style="float: left;">11月</a>
       		<a href="addRecord.html" class="check-a" style="float: right; margin-bottom: 20px;">添加记录</a>
       		<br />
       </header>
    	<table class="table table-striped table-hover table-bordered qf_record" id="editabledatatable" style="text-align: center;">
            ...
            <tbody style="font-size: 12px;font-weight: normal;">
                <tr>
                    <td class="red">
                    	<a href="checkDetail.html">2017-11-03</a>
                    </td>
                    <td class="red">5</td>
                    <td>
                        <a href="checkDetail.html" class="btn btn-info btn-xs edit"><i class="glyphicon glyphicon-folder-open"></i> 详情</a>
                    </td>
                </tr>
