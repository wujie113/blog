...
<script type="text/javascript">
	$('#addmanageType').click(function(){
		...
		$('.qf_bomb_type').css('display','block');
	});
	$('#webType').click(function(){
		$('.qf_fixed').css('display','none');
		$('.qf_bomb_type').css('display','none');
	});
	function fn(){
		$('.qf_fixed').css('display','block');
		$('.qf_bomb_type').css('display','block');
